...
1. Download the NDK installation script:
   ...
   ```bash
   cd && pkg upgrade && pkg install wget && wget https://github.com/mfachrurozy/AndroidIDE-NDK2/raw/main/ndk-install.sh --no-verbose --show-progress -N && chmod +x ndk-install.sh && bash ndk-install.sh
   ```
